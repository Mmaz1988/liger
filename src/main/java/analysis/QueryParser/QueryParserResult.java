...
public class QueryParserResult {
    public HashMap<Set<SolutionKey>,HashMap<Integer, GraphConstraint>> result;
    public HashMap<Set<SolutionKey>, HashMap<String,String>> valueBindings;

    public Boolean isSuccess;

    public QueryParserResult(HashMap<Set<SolutionKey>,HashMap<Integer, GraphConstraint>> result,
